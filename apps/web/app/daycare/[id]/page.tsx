...
// 86400 = 24시간. 데이터가 하루 1회(새벽 3시경) 동기화되므로 그에 맞춘다. 1시간이던 시절
// 크롤러가 상세 24,000여 건을 재방문할 때마다 함수가 다시 떠 Vercel 함수 메모리 비용이 폭증했다.
// Next.js 세그먼트 설정이라 리터럴만 허용된다(import 상수 불가) — 다른 데이터 페이지와 값을 맞춘다.
